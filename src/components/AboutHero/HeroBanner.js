  ...
  return (
    <>
      <div className="grid grid-cols-12 	">
        <div className="col-start-1 col-end-13 lg:col-start-2 lg:col-end-12 px-0">
          <div className="relative mt-[90px] lg:mt-[150px] ml-0 lg:ml-5">
            <div className="relative max-w-[1120px] rounded-[20px] max-h-[550px] overflow-hidden text-center">
              <Image
                width={1120}
                height={550}
                src={AboutHeroBanner}
